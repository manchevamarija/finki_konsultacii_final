...
```
cd existing_repo
git remote add origin https://gitlab.finki.ukim.mk/wp/konsultacii.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.finki.ukim.mk/wp/konsultacii/-/settings/integrations)
